...
module.exports = async function(callback) {
    try {
        ...
        fs.writeFileSync('./driverOptions.json', JSON.stringify({
            contractRegistryForExistingContractsAddress: d.contractRegistry.address,
        }, null, 2));

        console.log('overriding driver options file for migration test:', JSON.parse(fs.readFileSync("driverOptions.json")));
    } catch (e) {
